...
import { request } from "../../../requisicoes/ProdutoRequisicoes/atualizar/request";
import { useParams } from "react-router-dom";

const ProdutoAtualizarForm = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isADM !== "true" || !token) {
            setMensagem("Apenas administradores podem atualizar produtos.");
            return;
        }
        ...
        try {
            setLoading(true);
          const response = await request(`/restrito/produto?id=${id}`, produto, token);
...
export default ProdutoAtualizarForm;
